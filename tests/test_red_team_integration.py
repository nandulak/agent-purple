        ...
        for file_name in TEST_FILES:
            ...
            if os.path.exists(file_path):
                ...
                if file_content:
                    ...
                    logger.info(
                        f"Found {result['vulnerability_count']} vulnerabilities"
                    )
                    ...
                    for i, vuln in enumerate(result.get("vulnerabilities", [])):
                        ...
                        if "framework_mappings" in vuln:
                            ...
                            if attack.get("tactics"):
                                tactics = [
                                    f"{t.get('id', 'N/A')} ({t.get('name', 'N/A')})"
                                    for t in attack.get("tactics", [])
                                ]
                            ...
                            if attack.get("techniques"):
                                techniques = [
                                    f"{t.get('id', 'N/A')} ({t.get('name', 'N/A')})"
                                    for t in attack.get("techniques", [])
                                ]
                                logger.info(
                            ...
                            if atlas.get("techniques"):
                                techniques = [
                                    f"{t.get('id', 'N/A')} ({t.get('name', 'N/A')})"
                                    for t in atlas.get("techniques", [])
                                ]
                                logger.info(
                                    f"  ATLAS Techniques: {', '.join(techniques)}"
                                )
